    ...
    return (
        <div>
            ...
            <div className="form-container">
                <h1 style={{ marginBottom: '20px' }}>Kayıt Ol 📝</h1>
                ...
                <button className="btn-primary" style={{ width: '100%', marginBottom: '15px' }} onClick={handleRegister}>
                    Kayııt İşlemini Tamamla
                </button>
                {mesaj && <p style={{ color: 'var(--success)' }}>{mesaj}</p>}
                
                <button style={{ width: '100%', padding: '10px', background: 'transparent', border: '1px solid var(--border)', color: 'white', borderRadius: '8px', cursor: 'pointer' }} onClick={() => navigate('/login')}>
